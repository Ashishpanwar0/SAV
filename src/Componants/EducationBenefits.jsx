...
const EducationBenefits = () => {
  const totalStudents = 300; // students changes any time 
  ...
  return (
    <section className="bg-[#F9FAFB] py-15">
      <div className="relative max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-10 items-center">
        {/* Left */}
        <div>
          <p className="text-[#0AB1F0] font-semibold Body-text">Importance of Education</p>
          ...
          {/* <Link
            to="/"
            className="bg-[#92C56C] text-white px-6 py-3 rounded-md font-semibold hover:bg-[#7fb95a] transition"
          >
            Join Us Now
          </Link> */}

          <div className="mt-10 bg-[#f7fdf4] border-l-4 border-[#92C56C] p-5 rounded-lg inline-block">
            <h3 className="text-5xl font-bold text-[#92C56C] Heading-text">{count}</h3>
